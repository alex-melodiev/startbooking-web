...
class ReportsController extends Controller
{
    ...
    public function salesAnalysis()
    {
        ...
        isset($_GET['year']) ? $data['year'] = $_GET['year'] : $data['year'] = '';
        isset($_GET['property']) ? $data['allproperties'] = $_GET['property'] : $data['allproperties'] = '';
        if (isset($_GET['reset_btn'])) {
            $_GET['year'] = $data['year']  = '';
            $_GET['property'] = $data['allproperties']   = '';
        }

        if (isset($_GET['property'])) {
            $data['properties'] = $property = Properties::where('properties.id', $_GET['property'])->select('id', 'name')->get();
        } else {
