...
class Common {
    ...
    public function prev_get_price($property_id, $checkin, $checkout, $guest_count)
    {
        ...
        $result['total']            = floatval(preg_replace('/[^\d.]/', '',$result['service_fee'])) + floatval(preg_replace('/[^\d.]/', '',$result['total_night_price'])) + floatval(preg_replace('/[^\d.]/', '',$result['additional_guest'])) + floatval(preg_replace('/[^\d.]/', '',$result['security_fee'] + $result['cleaning_fee']));
        $result['subtotal']         = floatval(preg_replace('/[^\d.]/', '',$result['service_fee'])) + floatval(preg_replace('/[^\d.]/', '',$result['total_night_price'])) + floatval(preg_replace('/[^\d.]/', '',$result['additional_guest'])) + floatval(preg_replace('/[^\d.]/', '',$result['security_fee'] + $result['cleaning_fee']));
    ...
    public function get_price($property_id, $checkin, $checkout, $guest_count)
    {
