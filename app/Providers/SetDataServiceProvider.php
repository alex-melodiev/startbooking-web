...
class SetDataServiceProvider extends ServiceProvider
{
    ...
    public function settings()
    {
        ...
        if (!empty($settings)) {
            ...
            $name = !empty($general['name']) ? $general['name'] : env('APP_NAME', 'Vacation Rental');
            ...
            //App email logo
            if (!empty($general['email_logo']) && file_exists(public_path('public/front/images/logos/'. $general['email_logo']))) {
            ...
            //App favicon
            if (!empty($general['favicon']) && file_exists(public_path('public/front/images/logos/'. $general['favicon']))) {
                $favicon = url('public/front/images/logos/'. $general['favicon']);
            } else {
                $favicon = env('APP_FAVICON_URL') != '' ? env('APP_FAVICON_URL') : url('public/front/images/logos/favicon.ico');
            }
