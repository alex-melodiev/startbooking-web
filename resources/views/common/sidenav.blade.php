...
@if (Route::current()->uri() == 'users/security' || Route::current()->uri() == 'users/account-preferences' || Route::current()->uri() == 'users/transaction-history')
  <li>
  ...
  <li>
    <a href="{{ url('users/transaction-history') }}" aria-selected="{{ (Route::current()->uri() == 'users/transaction-history') ? 'true' : 'false'}}" class="sidenav-item">{{trans('messages.account_sidenav.transaction_history')}}</a>
  </li>
