                    ...
                    @if(!$reviewsAboutYou[$i]->hidden_review)
                      <li class="media reviews-list-item row-space-top-2">
                          ...
                          <div class="media-body response">
                            <p>{{ $reviewsAboutYou[$i]->message }} <a href="{{ url('/') }}/reviews/details/{{ $reviewsAboutYou[$i]->id }}" class="btn ex-btn">{{ trans('messages.reviews.view_details') }}</a></p>
                            <hr>            
                          </div>
                      </li>
                    @else
                ...
                <li class="media reviews-list-item row-space-2">
                  ...
                  <div class="media-body">
                    ...
                    <ul class="list-unstyled">
                      ...
                      <li>
                         @if(Auth::user()->id==$reviewsToWrite[$i]->review_user(Auth::user()->id)->id)
                     ...
                     @if(@$expired == 1)
                      <li class="media reviews-list-item row-space-top-2">
                        ...
                        <div class="media-body response">
                          ...
                          <div>
                             @if(Auth::user()->id==$expiredReviews[$i]->review_user(Auth::user()->id)->id)
