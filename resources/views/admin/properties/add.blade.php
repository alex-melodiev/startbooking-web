        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1" class="control-label col-sm-3">User <span style="color: red !important;">*</span></label>
              ...
              <div class="col-sm-2">
                <a href="#" data-toggle="modal" data-target="#customerModal" class=" btn btn-primary btn-sm" style="margin-top:4px;float: left;width: 100%"><span class="fa fa-user"></span></a>
              </div>
           ...
           <div class="col-sm-6">
            ...
            <div class="form-group">
              <label for="exampleInputPassword1" class="control-label col-sm-3">{{trans('messages.property.city')}} <span style="color: red !important;">*</span></label>
              <div class="col-sm-6">
              ...
              <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="signup_form" method="post" name="signup_form" accept-charset='UTF-8'>
                              ...
                              <div class="form-group">
                                  <label for="Password" class="control-label col-sm-3">Password<span style="color: red !important;">*</span></label>
                                  <div class="col-sm-8">
                                    <input type="password" class="form-control" name="password" id="password" placeholder="">
                                    {{-- <span id="error_msg" style="color: red;font-weight: bold; font-size:13px"></span> --}}
                                  </div>
                              </div>
                              <div class="form-group">
