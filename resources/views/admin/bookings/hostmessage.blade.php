              ...
              <div class="col-md-9 col-sm-9 col-xs-12">
                ...
                <div class="col-lg-12 row" style="margin-left:0px;">
                  <form action="{{url('admin/reply/'.$messages[0]->booking_id )}}" method="post" id="msg_reply">
                    ...
                    <span style="float:right;"><input type="submit" class="btn ex-btn navbar-btn topbar-btn btn-success" id="reply_message" value="{{ trans('messages.booking_my.send_message') }}"></span>
                  </form>
