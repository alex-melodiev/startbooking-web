...
$(document.body).on('submit', "#icalendar_form", function(e){
  ...
  //if(frequency_time == '') $('#error-dtpc-frequency-time').html('This field is required.');
  ...
  $.ajax({
      ...
      //data: {'url':url, 'name':name,'property_id':property_id,'frequency_time':frequency_time,'color':color,'customcolor':customColor},
      ...
      success: function(msg){
          if(msg.status==1){
            ...
            //$('#error-dtpc-frequency-time').html(msg.error.frquency_time);
